...
###################################
U_DD=unitary(fuse(space(AA2_Phyodd,1)*space(AA2_Phyodd,1)), space(AA2_Phyodd,1)*space(AA2_Phyodd,1));
global U_DD
###################################
...
v_init=TensorMap(randn, fuse(space(AA2_Phyodd,1)*space(AA2_Phyodd,1))*fuse(space(AA2_Phyodd,1)*space(AA2_Phyodd,1))*fuse(space(AA2_Phyodd,1)*space(AA2_Phyodd,1)),Rep[U₁](0=>1));
...
if y_anti_pbc
    ...
    matwrite("ES_freefermion_M2_Nv6_PBC"*".mat", Dict(
        "k_phase" => k_phase,
        "eu" => eu,
        "Qn"=>Qn
    ); compress = false)
