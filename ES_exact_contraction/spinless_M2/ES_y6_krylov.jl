...
global AA6_Phyeven_Vodd_Vodd, AA6_Phyeven_Vodd_Veven, AA6_Phyeven_Veven_Vodd, AA6_Phyeven_Veven_Veven
global AA6_Phyodd_Vodd_Vodd, AA6_Phyodd_Vodd_Veven, AA6_Phyodd_Veven_Vodd, AA6_Phyodd_Veven_Veven
global AA2_Phyodd, AA2_Phyeven,AA3_Phyodd, AA3_Phyeven,AA4_Phyodd, AA4_Phyeven,AA5_Phyodd, AA5_Phyeven
                    ...
                    for parity_P4=0:1
                        for parity_P5=0:1
                            for parity_P6=0:1
                                ...
                                @tensor vr_temp[:]:=AA1_temp[-1,2,1,12]*AA2_temp[-2,4,3,2]*AA3_temp[-3,6,5,4]*AA4_temp[-4,8,7,6]*AA5_temp[-5,10,9,8]*AA6_temp[-6,12,11,10]*vr_temp[1,3,5,7,9,11,-5];
                                vr=vr+vr_temp;
                            end
                        end
                    end
...
v_init=TensorMap(randn, space(AA2_Phyodd,1)*space(AA2_Phyodd,1)*space(AA2_Phyodd,1)*space(AA2_Phyodd,1)*space(AA2_Phyodd,1)*space(AA2_Phyodd,1),Rep[U₁](0=>1));
...
v_init=TensorMap(randn, space(AA2_Phyodd,3)*space(AA2_Phyodd,3)*space(AA2_Phyodd,3)*space(AA2_Phyodd,3)*space(AA2_Phyodd,3)*space(AA2_Phyodd,3),Rep[U₁](0=>1)');
...
if y_anti_pbc
    matwrite("ES_freefermion_M2_Nv6_APBC"*".mat", Dict(
        "k_phase" => k_phase,
        "eu" => eu,
        "Qn"=>Qn
    ); compress = false)
else
    matwrite("ES_freefermion_M2_Nv6"*".mat", Dict(
        "k_phase" => k_phase,
        "eu" => eu,
        "Qn"=>Qn
    ); compress = false)
