...
include("D:\\My Documents\\Code\\Julia_codes\\Tensor network\\GfPEPS_parton\\ES_CTMRG\\Entropy.jl")
...
flux_gate=gauge_gate(A,2,0.5);


#Entropy_finite_size(CTM,U_L,U_D,U_R,U_U,M,chi,N);

Topo_entropy_Renyi2(CTM,U_L,U_D,U_R,U_U,M,chi,N_eu)
