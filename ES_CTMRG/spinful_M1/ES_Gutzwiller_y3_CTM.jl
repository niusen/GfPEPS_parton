...
@tensor VL[:]:=gateL[4,1]*Tleft[2,-1,1]*Tleft[3,-2,2]*Tleft[4,-3,3];
@tensor VR[:]:=gateR[4,1]*Tright[1,-1,2]*Tright[2,-2,3]*Tright[3,-3,4];




@tensor VL[:]:=VL[1,2,3]*U_L[1,-1,-2]*U_L[2,-3,-4]*U_L[3,-5,-6];#R1',R1,R2',R2,R3',R3
VL=permute(VL,(1,3,5,2,4,6,));#R1',R2',R3', R1,R2,R3


@tensor VR[:]:=VR[1,2,3]*U_L'[-1,-2,1]*U_L'[-3,-4,2]*U_L'[-5,-6,3];#L1',L1,L2',L2,L3',L3
VR=permute(VR,(2,4,6,1,3,5,));#L1,L2,L3,L1',L2',L3'




@tensor H[:]:=VL[-1,-2,-3,1,2,3]*VR[1,2,3,-4,-5,-6];#R1',R2',R3' ,L1',L2',L3'
...
matwrite("ES_CTM_Gutzwiller_M1_Nv3"*".mat", Dict(
    "k_phase" => k_phase,
    "eu" => eu,
    "Qn"=>Qn,
    "Spin"=>Spin
